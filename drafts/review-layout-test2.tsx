...
export const metadata: Metadata = {
  title: "Layout Test 2 — Hi! Drama",
};

type PortableTextValue = Parameters<typeof PortableText>[0]["value"];

export default async function Test2ReviewPage() {
  ...
  return (
    <article className="max-w-5xl mx-auto px-4 py-12">
      ...
      {/* Float layout: everything left, review flows right and expands full width */}
      <div className="relative">
        {/* Left column — floated: photo, cast & crew, show details */}
        <div className="float-left w-full sm:w-[280px] lg:w-[300px] sm:mr-6 mb-6">
          ...
          {hasCastAndCrew && (
            <div className="bg-white border border-purple-100 rounded-sm p-5 mb-4">
        ...
        {/* Review body — flows right of the float, expands full width when it clears */}
        {hasReviewBody && (
