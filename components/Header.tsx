    ...
    <header className="bg-purple-900 border-b-4 border-gold-600 shadow-lg">
      ...
      <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <Link href="/" className="group flex flex-col items-center sm:items-start">
          <span className="font-playfair text-3xl font-bold text-white tracking-wide group-hover:text-gold-400 transition-colors leading-tight">
            Hi! Drama
          </span>
          <span className="text-purple-300 text-xs tracking-widest uppercase font-lato">
              ...
              return (
                <li key={href}>
                  <Link
                    href={href}
                    className={`
                      font-lato text-sm font-semibold tracking-wide uppercase px-4 py-2 rounded
