...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* ── TV Schedule ────────────────────────────────────────────── */}
      <section className="bg-amber-400 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-sm border-4 border-amber-500 shadow-xl flex flex-col sm:flex-row items-stretch overflow-hidden">
            {/* Left slab */}
            <div className="bg-purple-900 text-white flex flex-col items-center justify-center px-8 py-6 sm:py-8 gap-2 shrink-0">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-12 h-12 text-amber-400">
            ...
            <div className="flex-1 px-6 py-6 flex flex-col justify-center gap-3">
              ...
              <p className="font-lato text-4xl sm:text-5xl font-black text-purple-800 leading-none tracking-tight">
                1:30–2:00 <span className="text-2xl sm:text-3xl font-bold text-amber-600">PM EST</span>
              </p>
              <div className="mt-1 flex flex-wrap gap-2">
                {[
                  ...
                  <div key={name} className="bg-purple-900 text-white rounded-sm px-4 py-2 flex flex-col items-center leading-tight">
                    ...
                    <span className="font-playfair font-bold text-amber-400 text-lg">{ch}</span>
                  </div>
                ))}
              </div>
            </div>
